...
task = sys.argv[1]
experiments = ['5000', '5000-layer_norm', '5000-lr-5x']
experiment_labels = ['default', 'layer norm', '5x learning rate']
...
plt.savefig(output_path+'zap-n-tune-5k_'+task+'.png', dpi=300)
